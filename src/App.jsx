    ...
    <div className="app">
      <header className="app-header">
        <div className="container">
          <h1>Prime Property Estate Agents</h1>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-info">
              <h3>Prime Property Estate Agents</h3>
              <p>Your trusted partner in finding the perfect home</p>
              <p className="footer-copyright">&copy; 2025 Prime Property Estate Agents. All rights reserved.</p>
            </div>
